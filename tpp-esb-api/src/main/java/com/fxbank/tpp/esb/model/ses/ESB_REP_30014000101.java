...
/** 
* @ClassName: ESB_REP_30014000101 
* @Description: 单笔冲正 
* @author Duzhenduo
* @date 2019年1月31日 下午3:50:18 
*  
*/
public class ESB_REP_30014000101 extends ESB_BASE {


	private static final long serialVersionUID = -307515788308362972L;

	@Deprecated
	public ESB_REP_30014000101() {
		super(null, 0, 0, 0);
	}

	public ESB_REP_30014000101(MyLog mylog, Integer sysDate, Integer sysTime, Integer sysTraceno) {
	...
	public class REP_BODY implements Serializable {
		...
		private static final long serialVersionUID = 1504175087757453059L;
