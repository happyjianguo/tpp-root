...
public class ESB_REP_30033000202 extends ESB_BASE {

	private static final long serialVersionUID = -703043711924272359L;

	@Deprecated
	public ESB_REP_30033000202() {
		super(null, 0, 0, 0);
	}

	public ESB_REP_30033000202(MyLog mylog, Integer sysDate, Integer sysTime, Integer sysTraceno) {
	...
	public class REP_BODY implements Serializable {
		...
		private static final long serialVersionUID = -3480290981024879784L;
		@JSONField(name = "TRAN_ID")
		private String tranId;//交易码
