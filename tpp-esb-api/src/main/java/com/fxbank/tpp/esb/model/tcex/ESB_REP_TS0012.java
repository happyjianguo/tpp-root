...
/** 
* @ClassName: ESB_REP_TS0012 
* @Description: 商行通兑村镇
* @author Duzhenduo
* @date 2019年1月31日 下午3:55:23 
*  
*/
public class ESB_REP_TS0012 extends ESB_BASE {

	private static final long serialVersionUID = -2496078829437573719L;

	@Deprecated
	public ESB_REP_TS0012() {
		super(null, 0, 0, 0);
	}

	public ESB_REP_TS0012(MyLog mylog, Integer sysDate, Integer sysTime, Integer sysTraceno) {
