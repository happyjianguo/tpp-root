package com.fxbank.cap.manager.utils;
...
//        Map map=cp.getPropertiesFileMap("/Users/LiuS/阜新银行项目/gjj/cap-root/cap-manager/etc/test.properties");
//        System.out.println("---------");
        //        File file = new File("/Users/LiuS/阜新银行项目/gjj/cap-root/cap-manager/etc/test.properties");
