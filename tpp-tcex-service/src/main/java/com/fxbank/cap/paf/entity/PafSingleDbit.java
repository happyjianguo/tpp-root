 ...
 * paf_single_dbit
 */
@Table(name = "paf_single_dbit")
@Alias("pafSingleDbit")
public class PafSingleDbit {
    /**
     * 平台日期
     */
    @Id
     ...
     * 付方账户行别:0、本行；1、跨行
     */
    @Column(name = "de_bankclass")
    private String deBankclass;

    /**
     * 多方协议号
     */
    @Column(name = "con_agrno")
    ...
    /**
     * 付方账户行别:0、本行；1、跨行
     * @return de_bankclass 付方账户行别:0、本行；1、跨行
     */
    ...
    /**
     * 付方账户行别:0、本行；1、跨行
     * @param deBankclass 付方账户行别:0、本行；1、跨行
     */
    public void setDeBankclass(String deBankclass) {
        this.deBankclass = deBankclass;
    }

    /**
     * 多方协议号
     * @return con_agrno 多方协议号
     */
