...
/**
 * paf_batch_loan_master
 */
@Table(name = "paf_batch_loan_master")
@Alias("pafBatchLoanMaster")
public class PafBatchLoanMaster {
    /**
     * 平台日期
     */
    @Id
    ...
    /**
     * 交易状态：0、接收；1、登记；2、处理中；3、处理完成；4、转入公积金账户；9、处理失败
     * @return tx_status 交易状态：0、接收；1、登记；2、处理中；3、处理完成；4、转入公积金账户；9、处理失败
     */
    ...
    /**
     * 交易状态：0、接收；1、登记；2、处理中；3、处理完成；4、转入公积金账户；9、处理失败
     * @param txStatus 交易状态：0、接收；1、登记；2、处理中；3、处理完成；4、转入公积金账户；9、处理失败
     */
