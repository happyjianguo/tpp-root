...
create table paf_batch_crdt_master(
	...
	tx_status varchar(1) comment '交易状态：0、接收；1、登记；2、核心转出总金额成功；3、处理中；4、处理完成；5、核心回退失败金额成功；9、处理失败',
	...
	roll_hostseqno varchar(32) comment '回退明细核心系统流水号' ,
	roll_hostrspcode varchar(20) comment '回退明细核心系统响应代码' ,
	roll_hostrspmsg	 varchar(120) comment '回退明细核心系统响应信息' ,
...
ALTER TABLE paf_batch_crdt_master ADD PRIMARY KEY PK_paf_batch_crdt_master (plat_date,plat_trace);
