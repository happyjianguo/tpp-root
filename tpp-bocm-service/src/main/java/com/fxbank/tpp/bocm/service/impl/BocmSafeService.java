...
public class BocmSafeService implements IBocmSafeService{
	...
	*/
	...
	@Override
	public void verifyBocmMac(MyLog myLog, byte[] dataToMAC,String macValue) throws SysTradeExecuteException {
		try {
	...
	public String calcBocm(MyLog myLog,byte[] dataToMAC) throws SysTradeExecuteException {
		try {
			...
			return BOCM.macDeginId+"|"+BOCM.macNodeId+"|"+BOCM.macKeyModelId+"|"+result.getMAC()+"|";
		} catch (Exception e) {
