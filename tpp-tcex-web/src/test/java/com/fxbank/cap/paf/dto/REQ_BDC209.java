...
public class REQ_BDC209 implements Serializable {
    ...
    public SER_REP_BDC generateReq(String str) {
        ...
        head.add(new FIELD("TxCode","BDC209"));
        ...
        //body.add(new FIELD("AcctNo","12009000094950"));
       // body.add(new FIELD("AcctNo","1200100003301602"));
