...
public class TownDeposit implements TradeExecutionStrategy {
	...
	* @throws 
	*/
	private ESB_REP_30011000103 hostCharge(REQ_TR0011 reqDto) throws SysTradeExecuteException {
		MyLog myLog = logPool.get();

		REQ_TR0011.REQ_BODY reqBody = reqDto.getReqBody();
		// 村镇编号
	...
	* @throws 
	*/
	private void initRecord(REQ_TR0011 reqDto) throws SysTradeExecuteException {
		MyLog myLog = logPool.get();
	...
	* @throws 
	*/
	private RcvTraceUpdModel updateHostRecord(REQ_TR0011 reqDto, String hostDate, String hostTraceno,
