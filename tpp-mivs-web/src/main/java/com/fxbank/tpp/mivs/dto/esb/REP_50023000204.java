...
public class REP_50023000204 extends REP_BASE {
    ...
    @JSONField(name = "BODY")
    private REP_50023000204.REP_BODY repBody = new REP_50023000204.REP_BODY();
    ...
    public REP_50023000204.REP_BODY getRepBody() {
        return repBody;
    }

    public void setRepBody(REP_50023000204.REP_BODY repBody) {
