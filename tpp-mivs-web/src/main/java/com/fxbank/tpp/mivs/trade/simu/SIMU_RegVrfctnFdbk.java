...
import com.fxbank.tpp.mivs.dto.mivs.MIVS_349_001_01;
...
public class SIMU_RegVrfctnFdbk implements TradeExecutionStrategy {
    ...
    public DataTransObject execute(DataTransObject dto) throws SysTradeExecuteException {
        ...
        // 1、接收349请求
        MIVS_349_001_01 mivs349 = (MIVS_349_001_01) dto;
        // 2、根据349内容模拟返回990
        ...
        mivs.getHeader().setMesgID(mivs349.getHead().getMesgID());
        mivs.getComConf().getConfInf().setMT("MT");
        mivs.getComConf().getConfInf().setMsgId(mivs349.getHead().getMesgID());
        ...
        ccms900.getHeader().setMesgID(mivs349.getHead().getMesgID());
        grpHdr.getInstgPty().setInstgDrctPty("0000");
        grpHdr.getInstgPty().setInstgPty("000012345678");
        grpHdr.setMsgId(mivs349.getHead().getMesgID());
        grpHdr.setCreDtTm(mivs349.getRegVrfctnFdbk().getMsgHdr().getCreDtTm());
        grpHdr.setSysCd("ACCT");
        grpHdr.setRmk("900回复");
        orgnlGrpHdr.setOrgnlMsgId(mivs349.getHead().getMesgID());
        orgnlGrpHdr.setOrgnlInstgPty(mivs349.getRegVrfctnFdbk().getMsgHdr().getInstgPty().getInstgDrctPty());
        ...
        cmonConfInf.setPrcDt(mivs349.getRegVrfctnFdbk().getMsgHdr().getCreDtTm());
        ...
        /**
         ...
         ccms911.getHeader().setMesgID(mivs349.getHead().getMesgID());
         ccms911.getDscrdMsgNtfctn().getDscrdInf().setMT("mivs.321.001.01");
         ccms911.getDscrdMsgNtfctn().getDscrdInf().setMsgId(mivs349.getGetIdVrfctn().getMsgHdr().getMsgId());
