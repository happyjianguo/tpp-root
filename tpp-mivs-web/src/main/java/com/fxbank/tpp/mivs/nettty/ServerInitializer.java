...
import com.fxbank.tpp.mivs.controller.TradeDispatcherHandler;
...
public class ServerInitializer extends ChannelInitializer<SocketChannel> {
	...
	@Autowired
	private MivsLengthEncoder bocmLengthEncoder;
	
	@Autowired
	private MivsPackConvOutHandler bocmPackConvOutHandler;
	
	@Autowired
	private MivsPackConvInHandler bocmPackConvInHandler;
	...
	public void initChannel(SocketChannel ch) {
		...
		p.addLast(new MivsLenghtDecoder(logPool));
