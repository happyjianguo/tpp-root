...
public class REP_10103 extends REP_BASE {
    ...
    public static class Detail implements Serializable{
    	...
    	private Double fee;
    	//通存通兑业务模式、
    	@FixedField(order = 812, len = 1, desc = "通存通兑业务模式")
    	private String txnMod;
    	//付款人开户行行号
    	@FixedField(order = 813, len = 12, desc = "付款人开户行行号")
    	private String payBnk;
    	//付款人账户类型
    	@FixedField(order = 814, len = 1, desc = "付款人账户类型")
    	private String PactTp;
    	//付款人账号
    	@FixedField(order = 815, len = 32, desc = "付款人账号")
    	private String PactNo;
    	//付款人名称
    	@FixedField(order = 816, len = 30, desc = "付款人名称")
    	private String payNam;
    	//收款人开户行行号
    	@FixedField(order = 817, len = 12, desc = "收款人开户行行号")
    	private String recBnk;
    	//收款人账户类型
    	@FixedField(order = 818, len = 1, desc = "收款人账户类型")
    	private String RactTp;
    	//收款人账号
    	@FixedField(order = 819, len = 32, desc = "收款人账号")
