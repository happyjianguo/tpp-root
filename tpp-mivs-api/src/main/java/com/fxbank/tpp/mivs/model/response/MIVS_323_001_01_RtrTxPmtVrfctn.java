...
public class MIVS_323_001_01_RtrTxPmtVrfctn implements Serializable, SIGN_DATA {
    ...
    public String signData() {
        ...
        if(this.getRspsn().getVrfctnInf().getRslt().equals("MCHD")) {
            ...
            sb.append(this.getRspsn().getVrfctnInf().getTxpmtInf().getTxAuthCd() + "|");
            sb.append(this.getRspsn().getVrfctnInf().getTxpmtInf().getTxAuthNm() + "|");
            sb.append(this.getRspsn().getVrfctnInf().getTxpmtInf().getTxpySts() + "|");
