...
public class AcctCheckErrModel extends ModelBase implements Serializable {

	public AcctCheckErrModel(MyLog mylog, Integer sysDate, Integer sysTime, Integer sysTraceno) {
