 ...
 *
 */
public class SndTraceRepModel extends ModelBase implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -5286410846158589890L;

	public SndTraceRepModel(MyLog mylog, Integer sysDate, Integer sysTime, Integer sysTraceno) {
