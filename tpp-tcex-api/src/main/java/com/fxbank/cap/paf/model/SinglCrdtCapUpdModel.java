...
public class SinglCrdtCapUpdModel extends ModelBase implements Serializable{
	
	private static final long serialVersionUID = 4985529026950360461L;
	
	public SinglCrdtCapUpdModel(MyLog mylog, Integer sysDate, Integer sysTime, Integer sysTraceno) {
