...
public class BatchCrdtRcvFileModel extends ModelBase implements Serializable{
	
	private static final long serialVersionUID = 4985529026950360461L;
	
	public BatchCrdtRcvFileModel(MyLog mylog, Integer sysDate, Integer sysTime, Integer sysTraceno) {
	...
	@Size(max = 6,message = "bus_type业务类型长度不能大于6")
	...
	@Size(max = 255,message = "de_acctname付方户名长度不能大于255")
	private String de_acctname;//付方户名
	
	@NotNull(message = "de_acctclass付方账户类别不能为空")
	@Size(max = 1,message = "de_acctclass付方账户类别长度不能大于1")
	private String de_acctclass;//付方账户类别
	
	@NotNull(message = "cap_amt付款本金金额不能为空")
	@Digits(integer = 14, fraction = 2,message = "cap_amt付款本金金额格式不正确")
	private String cap_amt;//付款本金金额
	
	@Size(max = 32,message = "de_intacctno付方利息户账号长度不能大于32")
	private String de_intacctno;//付方利息户账号
	
	@Size(max = 255,message = "de_intacctname付方利息户户名长度不能大于255")
	private String de_intacctname;//付方利息户户名
	
	@Size(max = 1,message = "de_intacctclass付方利息户类别长度不能大于1")
	private String de_intacctclass;//付方利息户类别
	
	@Size(max = 32,message = "de_intcracct利息收方账号长度不能大于32")
	private String de_intcracct;//利息收方账号
	
	private String int_amt;//付款利息金额
