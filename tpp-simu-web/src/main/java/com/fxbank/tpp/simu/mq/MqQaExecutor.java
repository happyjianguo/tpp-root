...
import com.fxbank.tpp.simu.controller.TradeDispatcherExecutor;
import com.fxbank.tpp.simu.dto.pmts.DTO_BASE;
...
public class MqQaExecutor {
    ...
    public void execute(String message) throws SysTradeExecuteException {
        MyLog myLog = null;
        try {
        ...
        String className = "com.fxbank.tpp.simu.dto.pmts" + "." + txCode;
        try {
        ...
        tradeDispatcherExecutor.txMainFlowController(txCode,dtoBase);
    }
