 ...
 */
@Component
public class MivsClient {

    private static Logger logger = LoggerFactory.getLogger(MivsClient.class);
    ...
    public <T> T comm(MyLog myLog,Object req,Class<T> clazz) throws SysTradeExecuteException {
        ...
        MivsInitializer<T> initializer = new MivsInitializer<T>(myLog, slot, req,clazz);
