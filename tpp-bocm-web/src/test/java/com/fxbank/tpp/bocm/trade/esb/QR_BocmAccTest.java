...
public class QR_BocmAccTest {

	private static Logger logger = LoggerFactory.getLogger(QR_BocmAccTest.class);
	...
	private REQ_30063001301 req;
	private REQ_SYS_HEAD reqSysHead;
	private REQ_30063001301.REQ_BODY reqBody;

	@Before
	public void init() {
		req = new REQ_30063001301();
		reqSysHead = new REQ_SYS_HEAD();
		reqSysHead.setServiceId("300630013");
	...
	public void payOk() throws Exception {
		reqBody.setAcctNoT("6222600530011742438");
		reqBody.setAcctTpT("2");
		reqBody.setRcveWyT("1");
		reqBody.setTrnsTpT8("00");
		reqBody.setTrsrAmtT3("100000");
